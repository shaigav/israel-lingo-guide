            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div>
                ...
                <div className="prose prose-lg max-w-none text-muted-foreground space-y-4">
                  <p>
                    הקמת בניין בן 6 קומות באגף הקידמי הכולל 2 קומות חניון וכן 4 קומות מגורים. 
                    סה"כ 18 יחידות דיור, תוך הריסת מבנה קיים בהתאם להוראות תמ"א 38/3.
                  </p>
                  <p>
                    הפרויקט ממוקם על קו פרשת המים של רכס הכרמל, ברחוב הרופא 25 בחיפה - 
                    רחוב יוקרתי החשוף לנוף מרהיב, במיקום מרכזי בשכונת אחוזה.
                  </p>
                  <p>
                    הבניין פונה לוואדי פתוח ונשקף ממנו נוף ים מלא. סביבת הבניין מפותחת פיתוח מלא, 
                    בקרבת מרכז הקניות מרכז חורב, מרכז רפואי ובית חולים כרמל.
                  </p>
                </div>
              </div>
              ...
              {/* Location */}
              <div>
                <h2 className="text-2xl font-bold text-foreground mb-6">מיקום</h2>
                <div className="prose prose-lg max-w-none text-muted-foreground space-y-4">
                  <p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <img 
              src={heroImage} 
              alt="הדמיית הפרויקט" 
              className="w-full aspect-video object-cover rounded-lg shadow-md hover:shadow-xl transition-shadow cursor-pointer"
            />
          </div>
        </div>
      </section>
