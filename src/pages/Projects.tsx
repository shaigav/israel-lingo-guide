          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div>
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  שכונת אחוזה הינה שכונה ותיקה במרכזו של רובע המגורים רמות הכרמל בחיפה, השוכן על קו פרשת המים של רכס הכרמל. רובע אחוזה נמשך לאורך גב ההר, כאשר שיפוליו הצפוניים מזרחיים צופים על מפרץ חיפה והדרומיים מערביים על מישור חוף הכרמל. גובהו נע בין 200 מטר מעל פני הים. ציר התחבורה המרכזי של אחוזה הוא שדרות מוריה והמשכה רחוב חורב ושדרות אבא חושי. כיכר חורב, שבלב אחוזה הוותיקה, מקשרת את עורקי התחבורה מארבעה כיוונים. בסביבת הנכס מצוי מרכז הקניות מרכז חורב, שמעליו מרכז רפואי ובית חולים כרמל.
                </p>
              </div>
